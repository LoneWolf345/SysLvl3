...
public class SysLvlDbHelper extends SQLiteOpenHelper {
     ...
     */
	public SysLvlDbHelper(Context context) {
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		Log.w(SysLvlDbHelper.class.getName(), "Upgrading database from version " + oldVersion + " to " + newVersion + ", which will destrou all old data");
