...
public class SysLvlSplashActivity extends SysLvlActivity {
     ...
     // Transition to Main Menu when bottom title finishes animating
        fade1.setAnimationListener(new AnimationListener() {
            public void onAnimationEnd(Animation animation) {
                ...
                startActivity(new Intent(SysLvlSplashActivity.this, SysLvlMenuActivity.class));
                SysLvlSplashActivity.this.finish();
            }
